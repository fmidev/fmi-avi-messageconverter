...
@FreeBuilder
@JsonDeserialize(builder = WSVASIGMETImpl.Builder.class)
...
public abstract class WSVASIGMETImpl implements WSVASIGMET, Serializable {

    public static WSVASIGMETImpl immutableCopyOf(final WSVASIGMET sigmet) {
        Objects.requireNonNull(sigmet);
        if (sigmet instanceof WSVASIGMETImpl) {
            return (WSVASIGMETImpl) sigmet;
        } else {
            return Builder.from(sigmet).build();
        }
    }

    public static Optional<WSVASIGMETImpl> immutableCopyOf(final Optional<WSVASIGMET> sigmet) {
        Objects.requireNonNull(sigmet);
        return sigmet.map(WSVASIGMETImpl::immutableCopyOf);
    }
    ...
    public static class Builder extends WSVASIGMETImpl_Builder {

        public Builder() {
          this.setTranslated(false);
        }

        public static Builder from(final WSVASIGMET value) {
            if (value instanceof WSVASIGMETImpl) {
                return ((WSVASIGMETImpl) value).toBuilder();
            } else {
