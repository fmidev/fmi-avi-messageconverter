...
public class TrendForecastSurfaceWindImpl implements TrendForecastSurfaceWind {
    ...
    /* (non-Javadoc)
     * @see fi.fmi.avi.data.TrendForecastSurfaceWind#setMeanWindDirection(fi.fmi.avi.data.NumericMeasure)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see fi.fmi.avi.data.TrendForecastSurfaceWind#setMeanWindSpeed(fi.fmi.avi.data.NumericMeasure)
     */
    @Override
    @JsonDeserialize(as = NumericMeasureImpl.class)
    ...
    /* (non-Javadoc)
     * @see fi.fmi.avi.data.TrendForecastSurfaceWind#setWindGust(fi.fmi.avi.data.NumericMeasure)
     */
    @Override
    @JsonDeserialize(as = NumericMeasureImpl.class)
