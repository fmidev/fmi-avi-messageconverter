...
public abstract class IWXXMConverter {
      ...
      if (objectFactory != null) {
        ...
        if (clz.getEnclosingClass() != null) {
          ...
          StringBuilder sb = new StringBuilder("create")
              .append(encClass.getSimpleName().substring(0, 1).toUpperCase())
          ...
          methodName = new StringBuilder("create")
              .append(clz.getSimpleName().substring(0, 1).toUpperCase())
    ...
    private static Object getObjectFactory(Class<?> clz) {
      ...
      } catch (ClassCastException|NoSuchMethodException|IllegalAccessException|IllegalAccessError|InstantiationException
